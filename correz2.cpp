//corregge il file supponendo che gli outliers in y siano reali
...
void correz(){
  ...
  //Bin per chamber histograms
   ...
   for (int a = 0; a < 24; a++) {
     for (int b = 1; b <= 400; b++) {
       ...
       if (bc1 == 0) {if(check == 0) temp = double(b)*2; check = 1;}
       else check = 0;
     }
 ...
 for (int a = 0; a < 24; a++) {
     for (int b = 1; b <= 400; b++) {
       ...
       if (bc2 == 0) {if(check == 0) temp = double(b)*2; check = 1;}
       else check = 0;
     }
 ...
 for (int a = 0; a < 24; a++) {
     for (int b = 1; b <= 400; b++) {
       ...
       if (bc3 == 0) {if(check == 0) temp = double(b)*2; check = 1;}
       else check = 0;
     }
