...
void top_mid_tracks(){
  ...
  int cellx = 0, celly = 0;
  int check[umax][vmax];
  TH2F* eff_zone = new TH2F("eff_zone","Efficienza a zone, camera 3",96,-39.2917,39.2917,2,-79,79);
  ...
  // double parameter = 0;
   ifstream run("../EEEData/CORR_EEE_Prova_SCINT9000__20140603_175916.txt"); //INPUT FILE  
  TFile rfile("bot_zone9000.root","RECREATE");
  triplet n1;
  int j = 0;
  double number = 0;
  string line;
