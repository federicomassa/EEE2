...
void SetPoints(point x1, point x2, point x3){
  ...
  void YXFit(){   
    ...
    // xygraph = graph1;
      ...
      delete yxgraph;
        yxfitfunc = new TF1("yxfittingfunction", "[0]+[1]*x",-100,100);
        yxgraph = new TGraphErrors(3,yv,xv,yerr,xerr);
  	yxfitfunc->SetParameters(YXGetIntercept(), YXGetSlope());
	yxfr = yxgraph->Fit(yxfitfunc,"0Q");
  ...
  void ZXFit(){   
    ...
    // xygraph = graph1;
      ...
      delete zxgraph;
        zxfitfunc = new TF1("zxfittingfunction", "[0]+[1]*x",-100,100);
        zxgraph = new TGraphErrors(3,zv,xv,zerr,xerr);
  	zxfitfunc->SetParameters(ZXGetIntercept(), ZXGetSlope());
	zxfr = zxgraph->Fit(zxfitfunc,"0Q");
